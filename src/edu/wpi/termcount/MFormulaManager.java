 ...
 *
 */
class MGEManagerException extends Exception
{
...
public class MFormulaManager 
{
	...
	public static void printStatistics()
	{
		...
		System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
		System.out.println("Formula Manager statistics:");
		System.out.println("Variables: "+vars.size());
		System.out.println("Variable Tuples: "+varTuples.size());				           
		System.out.println("Relations: "+relations.size());
		System.out.println("Decls: "+declNodes.size());
		...
		System.out.println("Multiplicity formulas (one, lone, some, and no): "+iTotalMultip);
		System.out.println("Atomic formulas: "+atomFormulas.size());
		System.out.println("Negation formulas: "+negFormulas.size());
		System.out.println("Conjunction formulas: "+andFormulas.size());
		System.out.println("Disjunction formulas: "+orFormulas.size());
		System.out.println("Quantified Formulas (exists): "+existsFormulas.size());
		System.out.println("Quantified Formulas (forall): "+forallFormulas.size());
		...
		System.out.println("Total formulas: "+ iTotalFormulas);
		System.out.println("(It is normal for a handful of conjunctions and disjunctions to always remain:");
		System.out.println("empty conjunction, empty disjunction, singleton true, etc.)");
		System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");

		//MemoryMXBean memoryBean = ManagementFactory.getMemoryMXBean();

		//System.out.println("MemoryMXBean statistics (heap):");
		//System.out.println(memoryBean.getHeapMemoryUsage());		

		//System.out.println("MemoryMXBean statistics (non-heap):");		
		...
		System.out.println("\nTotal references (Formulas, Variables, Decls, etc.) reclaimed over the life of this Manager: "+lReclaimed);
